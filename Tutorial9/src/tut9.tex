...
\begin{frame}[fragile]
    ...
    What is the output of the following code?
    % TODO: fill in mcq 6 code
    \begin{minted}{python}
    \end{minted}
    % TODO: fill in mcq 6 options
    \begin{itemize}
        \item A.
        \item B.
        \item C.
...
\begin{frame}[fragile]
    ...
    \begin{minted}{python}
    \end{minted}
    % TODO: fill in mcq 6 options and alert correct one
    \begin{itemize}
        \item A.
        \item B.
        \item C.
    ...
    Explanation:
    % TODO: fill in mcq 6 explanation
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Don't forget tutorial 9 exercises\\(due on \textbf{TOMORROW November 21 23:59})!
